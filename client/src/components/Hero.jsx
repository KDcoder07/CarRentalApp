    ...
    return (
        ...
        justify-between p-6 rounded-lg md:rounded-full w-full max-w-200 md:mask-x-to-yellow-200
        ...
        <button className='flex items-center justify-center gap-1 px-9 py-3 
            max-sm:mt-4 bg-primary hover:bg0-primary-dull text-white rounded-full
            cursor-pointer'>
